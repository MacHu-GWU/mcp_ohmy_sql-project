...
class TestSaHubMixin:
    def test_get_database_and_schema_object(self):
        flag, msg, database, schema = hub.get_database_and_schema_object(
            "invalid database"
        )
    ...
    def test_get_schema_info(self):
        ...
        schema_info = hub.get_schema_info(database, schema)
